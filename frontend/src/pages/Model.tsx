        ...
        <div className="mt-10 space-y-10">
          ...
          <div>
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <ChartImage src={`${API_URL}/model-assets/training_history.png`} alt="Training accuracy and loss curves" />
              <ChartImage src={`${API_URL}/model-assets/confusion_matrix.png`} alt="Confusion matrix" />
              <ChartImage src={`${API_URL}/model-assets/class_distribution.png`} alt="Training set class distribution" />
            </div>
          </div>
        </div>
      )}
